...
class SplashScreenState extends State<SplashScreen>
  ...
  void checkIsUserAuthenticated() async {
    ...
    if (authenticationState == AuthenticationState.authenticated) {
      print("check checkIsUserAuthenticated");
      ...
      print("check un checkIsUserAuthenticated");
  ...
  void navigateCheck() {
    ...
    if (isTimerCompleted && isLanguageLoaded) {
      print("check navigateToScreen");
      navigateToScreen();
    } else {
      print(
          "check navigateToScreen else $isTimerCompleted && $isSettingsLoaded && $isLanguageLoaded");
    }
  }
      ...
      child: BlocListener<FetchSystemSettingsCubit, FetchSystemSettingsState>(
        listener: (context, state) {
          ...
          if (state is FetchSystemSettingsSuccess) {
            ...
            print("else error ${AppSettings.baseUrl}");
          }
        },
