...
//   void loadInitialData({bool? loadWithoutDelay}) {
//     context
//         .read<SliderCubit>()
//         .fetchSlider(context, loadWithoutDelay: loadWithoutDelay);
//     context
//         .read<FetchCategoryCubit>()
//         .fetchCategories(loadWithoutDelay: loadWithoutDelay);
//     context
//         .read<FetchMostViewedPropertiesCubit>()
//         .fetch(loadWithoutDelay: loadWithoutDelay);
//     context
...
//         .fetchCityCategory(loadWithoutDelay: loadWithoutDelay);
//     context
...
//   }
  ...
  Widget build(BuildContext context) {
    ...
    log(HiveUtils.getUserId().toString(), name: "USER ID");
          ...
          return SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                    onTap: () {
                      // Map<String, double> getWidgetInfo =
                      //     _getWidgetInfo(context, thisITemkye);
      ...
      builder: (context, state) {
        ...
        if (state is FetchMostViewedPropertiesSuccess) {
          return GridView.builder(
            ...
            itemCount: state.properties.length.clamp(0, 4),
            itemBuilder: (context, index) {
              log("MOST VIEWED : ${state.properties.length}");
              PropertyModel property = state.properties[index];
              property = context.watch<PropertyEditCubit>().get(property);
              return GestureDetector(
                onTap: () {
